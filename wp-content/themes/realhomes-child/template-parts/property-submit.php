        ...
        <div class="row-fluid">
            ...
            <div class="span6">
                ...
                <div class="form-option">
                    ...
                    <textarea class="required" name="description" id="description" cols="30" rows="5" title="<?php _e( '* Please provide property description!', 'framework'); ?>" required></textarea>
                </div>
                ...
                <div class="form-options-container clearfix">
                    ...
                    <div class="form-option">
                        ...
                        <span class="selectwrap">
                            <select name="type" id="type" class="search-select required" title="<?php _e( '* Please select property type!', 'framework'); ?>" required>
                    ...
                    <div class="form-option">
                        ...
                        <span class="selectwrap">
                            <select name="city" id="city" class="search-select required" title="<?php _e( '* Please select property city!', 'framework'); ?>" required>
                                <option selected="selected" value="-1"><?php _e('None', 'framework'); ?></option>
                                <?php
                                /* Property City */
                    ...
                    <div class="form-option">
                        ...
                        <span class="selectwrap">
                            <select name="status" id="status" class="search-select required" title="<?php _e( '* Please select property status!', 'framework'); ?>" required>
                                <option selected="selected" value="-1"><?php _e('None', 'framework'); ?></option>
                                <?php
                                /* Property Status */
                    ...
                    <div class="form-option">
                        ...
                        <input id="bedrooms" class="required" name="bedrooms" type="text" title="<?php _e( '* Please provide the value in only digits!', 'framework'); ?>" required/>
                    </div>
                    ...
                    <div class="form-option">
                        ...
                        <input id="bathrooms" class="required" name="bathrooms" type="text" title="<?php _e( '* Please provide the value in only digits!', 'framework'); ?>" required/>
                    </div>

                    <div class="form-option">
                        <label for="garages"><?php _e('Garages', 'framework'); ?></label>
                        <input id="garages" class="required" name="garages" type="text" title="<?php _e( '* Please provide the value in only digits!', 'framework'); ?>" required/>
                    </div>
                    ...
                    <div class="form-option">
                        ...
                        <input id="price" class="required" name="price" type="text" title="<?php _e( '* Please provide the value in only digits!', 'framework'); ?>" required/>
                    </div>

                    <div class="form-option">
                        <label for="price-postfix"><?php _e('Price Postfix Text','framework'); ?></label>
                        <input id="price-postfix" class="required" name="price-postfix" type="text" title="<?php _e( '* Please provide price postfix text!', 'framework'); ?>" required/>
                    </div>
                    ...
                    <div class="form-option">
                        ...
                        <input id="size" class="required" name="size" type="text" title="<?php _e( '* Please provide the value in only digits!', 'framework'); ?>" required/>
                    </div>

                    <div class="form-option">
                        <label for="area-postfix"><?php _e('Area Postfix Text','framework'); ?></label>
                        <input id="area-postfix" class="required" name="area-postfix" type="text" value="<?php _e('Sq Ft','framework'); ?>" required/>
                    </div>
                    ...
                    <div class="form-option">
                        ...
                        <input id="property-id" class="required" name="property-id" type="text" title="<?php _e( 'Property ID', 'framework'); ?>" required/>
                    </div>

                    <div class="form-option">
                        <label for="video-url"><?php _e('Virtual Tour Video URL','framework'); ?></label>
                        <input id="video-url" class="required" name="video-url" type="text" title="<?php _e( 'Virtual Tour Video URL', 'framework'); ?>" required/>
                    </div>
				...
				<div class="form-option">
                    <div id="floor-plan-thumbs-container" class="clearfix"></div>
                    <div id="floor-plan-drag-and-drop">
                        <div class="drag-drop-msg"><i class="fa fa-cloud-upload"></i>&nbsp;&nbsp;<?php _e('Drag and drop images here','framework'); ?></div>
                        <div class="drag-or"><?php _e('or','framework'); ?></div>
                        <div class="drag-btn">
                            <a id="floor-plan-select-images" class="real-btn" href="javascript:;"><?php _e('Select Images','framework'); ?></a>
                        </div>
                    </div>
                    <div class="field-description">
                        <?php _e( '* An image should have minimum width of 770px and minimum height of 386px.', 'framework' ); ?><br/>
                    ...
                    <div id="floor-plan-plupload-container"></div>
                    <div id="floor-plan-errors-log"></div>
                </div>
            </div>
            ...
            <div class="span6">
                ...
                <div class="form-option">
                    ...
                    <div class="map-wrapper">
                        ...
                        <input type="hidden" name="location" class="map-coordinate" value="<?php echo get_option( 'theme_submit_default_location' ); ?>" />
                    </div>
                </div>
