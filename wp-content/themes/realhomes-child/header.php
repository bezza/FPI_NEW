...
<body <?php body_class(); ?>>
        ...
        <div class="header-wrapper">
            ...
            <div class="container"><!-- Start Header Container -->
				...
				<div class="mobile-header">
					<!-- Logo -->
                    <div id="logo">
						<div class="menu-icon"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/menu.png" /></div>
						<div class="search-icon">
							<a href="<?php echo get_permalink(359); ?>"></a>
		...
		<div class="fixed-mobile-menu">
                        ...
                        ?>
						<div class="close-menu"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/close.png" /></div>
							<?php
           wp_nav_menu( array(
             'theme_location' => 'main-menu',
              'menu_class' => 'clearfix'
