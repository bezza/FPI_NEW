...
<![endif]-->
  ...
  ";
			...
			if($_POST['agent_email2'] != '' || $_POST['agent_email3'] != ''){
				$multiple_recipients = array();
				array_push ($multiple_recipients,$to_email);
				
				if($_POST['agent_email2'] != '')
				{
					array_push ($multiple_recipients,$_POST['agent_email2']);
				}
				
				if($_POST['agent_email3'] != '')
				{
					array_push ($multiple_recipients,$_POST['agent_email3']);
				}
			}
			else{
				$multiple_recipients = $to_email;
			}
            if ( wp_mail( $multiple_recipients, $email_subject, $email_body, $header ) ) {
