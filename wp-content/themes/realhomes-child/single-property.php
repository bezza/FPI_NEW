...
?>								
								...
								<div id="tabs" class="property-details">
										  ...
										  <ul class="tab">
											...
											<li><a href="#tabs-4" class="transport">Transport Links</a></li>
										  </ul>
								  ...
								  <div id="tabs-3" >
									<?php
											...
											if( $property_address && !empty($property_location) && $display_google_map == 'true')
											{
												...
												<!-- <script src="//maps.googleapis.com/maps/api/js?v=3.exp&signed_in=true&libraries=places,geometry"></script> -->
												<script>
