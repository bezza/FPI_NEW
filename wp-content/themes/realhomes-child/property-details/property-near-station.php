...
?>
	<div class="near-transport border-btm">
		<div class="transport-icon">
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/tube.png" />
		</div>
		<div class="transport-details">
			<p class="transport-name"><?php echo $con2->name; ?></p>
			<p class="transport-dis"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/men.png" />
...
?>
	<div class="near-transport border-btm">
		<div class="transport-icon">
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/bus.png" />
		</div>
		<div class="transport-details">
			<p class="transport-name"><?php echo $con2->name; ?></p>
			<p class="transport-dis"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/men.png" />
...
?>
<div class="clearfix"></div>
<div class="transport-seperator"></div>
<?php
//----------------------------train stop
...
?>
	<div class="near-transport border-btm">
		<div class="transport-icon">
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/train.png" />
		</div>
		<div class="transport-details">
			<p class="transport-name"><?php echo $con2->name; ?></p>
			<p class="transport-dis"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/men.png" />
...
<?php } ?>
	...
	<div class="near-transport border-btm">
		<div class="transport-icon">
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/airport.png" />
		</div>
		<div class="transport-details">
