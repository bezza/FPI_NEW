					...
					<div class="form-left">
						...
						<div class="enquiry-form">
							...
							<form id="agent_contact_form" class="contact-form-small" method="post" action="<?php echo site_url(); ?>/wp-admin/admin-ajax.php">
								...
								<textarea name="message" id="message" placeholder="<?php _e('Message', 'framework'); ?>" class="required" title="<?php _e('* Please provide message', 'framework'); ?>" class="modal_message"><?php echo $_COOKIE['message']; ?></textarea>
							...
							<p class="form_content">Please note that <a href="firstPropinvest.com" target="_blank">FirstPropinvest.com</a> will send the above details to <?php echo get_the_title( $agent );?> only. By submitting this form, you confirm that you agree to our website terms of use, our privacy policy and consent to cookies being stored on your computer.</p>
