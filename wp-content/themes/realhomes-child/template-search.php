                ...
                <div class="main">
                    ...
                    <section class="property-items">
                        ...
                        <div class="property-items-container clearfix">
                            ...
                            // Apply Search Filter
                            $search_args = apply_filters('child_real_homes_search_parameters',$search_args);

                            $search_args = child_sort_properties($search_args);
                    ...
                    </section>					<script type="text/javascript">						jQuery(document).ready(function(){							jQuery('.advance-search-form .avail-properties').html('<?php echo $search_query->found_posts;?> Properties Available')						});					</script>
