...
/*-----------------------------------------------------------------------------------*/
if( !function_exists('icl_object_id') ){    // property ID search feature do not work with WPML plugin
